...
a persistence unit "marianaisabel-frontend-proj5PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "marianaisabel-frontend-proj5\pom.xml":
...
artifact ("marianaisabel-frontend-proj5.war") is already built. You can build
