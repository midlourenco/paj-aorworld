...
const DeletedProjects=({errorTopBar="",isAdmin, userId, currentUser,editMode,handleEditClick,handleCancelClick, handleDeleteClick,...props})=>{
    const intl = useIntl();
    ...
    return (<>  
    <Heading pt={20} as="h3" ><FormattedMessage id={"my_deleted_projects"} />:</Heading>
        <TableContainer>
        <Table >
            <Thead>
            <Tr>
...
const mapStateToProps = state => {
  ...
  export default  connect(mapStateToProps, {})(DeletedProjects)
