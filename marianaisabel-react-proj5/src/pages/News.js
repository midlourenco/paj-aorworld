...
const n1 = {
    id:'99999',
    image: 'https://rockcontent.com/br/wp-content/uploads/sites/2/2020/02/projeto-pessoal.png',
...
function  News (){
    ...
    /**
     * seleccionar Keyword para filtrar noticias
     * @param {} keyword 
     */
  ...
  function setAppError(error){
    ...
    return (
        ...
        >
            ...
            : !loading?
                (<Text><WarningTwoIcon w={8} h={8} /> <FormattedMessage id={"error_noResults_news"} /> </Text> )
                :'Loading...'
            }
