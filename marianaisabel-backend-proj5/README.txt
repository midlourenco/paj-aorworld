...
a persistence unit "marianaisabel-backend-proj5PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "marianaisabel-backend-proj5\pom.xml":
...
artifact ("marianaisabel-backend-proj5.war") is already built. You can build
