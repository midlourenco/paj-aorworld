...
@XmlRootElement
public class UserDTORespSharingProject implements Serializable{
	 ...
	 * Construtor vazio
	 */
	public UserDTORespSharingProject() {
		//nothing to do here;
	}
	 ...
	 */
	public UserDTORespSharingProject(@NotBlank String firstName, @NotBlank String lastName,
